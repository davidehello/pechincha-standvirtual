export const translations = {
  pt: {
    ...
    filters: {
      ...
      gearbox: "Caixa",
      allGearboxTypes: "Todas as caixas",
      priceEvaluation: "Avaliação de Preço",
      allPriceEvaluations: "Todas as avaliações",
    ...
    admin: {
      ...
      waitingForGitHub: "A aguardar GitHub...",
  ...
  en: {
    ...
    filters: {
      ...
      gearbox: "Gearbox",
      allGearboxTypes: "All gearboxes",
      priceEvaluation: "Price Evaluation",
      allPriceEvaluations: "All evaluations",
